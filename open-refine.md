...
*Note: to save time, we have asked that you pre-install OpenRefine and create the demonstration projects ahead of time. You can find instructions and downloads in [Preparation](preparation). Please get in touch with the instructors if you run into any issues!*
