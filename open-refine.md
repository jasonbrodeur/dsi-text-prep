...
3. Split multi-valued cells using a space.
...
I could use this information to either harmonize the tokens, or to find the spot in the text in Column 1 I would like to correct.
